...
This file tracks the public evidence that should exist before submitting the Codex for Open Source application.

## Repository

- Repository URL: https://github.com/FreeWindTyler/thinking-island
- Expected demo URL: https://freewindtyler.github.io/thinking-island/
- Primary maintainer: `@FreeWindTyler`
- License: MIT

## Local Evidence Ready

- README with project purpose, run instructions, privacy-first principles, and demo link
- MIT License
- CONTRIBUTING guide
- SUPPORT guide
- SECURITY policy
...
- Confirm `Deploy GitHub Pages` workflow passes
